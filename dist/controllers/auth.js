...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!user) {
            return res.status(401).json(new Response_1.ResponseServer('Usuario y/o email inválido', false));
        }
        ...
        // generate user token 
        const token = (0, helpers_1.generateToken)(data, config_1.globalConfig.SECRET_KEY_TOKEN_SYSTEM, '12h');
        ...
        console.error(e);
        return res.status(500).json(new Response_1.ResponseServer('Ocurrio un error en login', false));
    }
});
exports.login = login;
const checkAuth = (req, res) => {
    try {
        ...
        // get data from token
        const data = (0, helpers_1.getPayloadToken)(authorization, config_1.globalConfig.SECRET_KEY_TOKEN_SYSTEM);
        // return response message
...
const updatePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return res.status(200).json(new Response_1.ResponseServer(`Contraseña actualizada correctamente`, true));
    }
    catch (e) {
        console.error(e);
        return res.status(500).json(new Response_1.ResponseServer('Ocurrio un error al actualizar el password', false));
    }
});
