...
routerInstitution.get(`/get-institutions/`, validateJWT, haveRole, institucionController.getInstitutions )
routerInstitution.get(`/get-one-institution/:modular_code`, validateJWT, haveRole, modularCodeValidator(), verifyError, institucionController.getOneInstitution )
