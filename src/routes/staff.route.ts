...
import { validateJWT, haveRole, staffMiddleware } from "../middlewares";
...
routerStaff.post(`/register-new-staff`, 
                validateJWT, 
                haveRole,
                staffValidator(), 
                verifyError, 
                ...
                verifyError, 
                staffMiddleware.existStaff,
                staffController.registerStaff)
routerStaff.patch(`/update-staff/:id_card`, 
                  validateJWT, 
                  idCardValidator(), 
                  verifyError, 
...
routerStaff.get(`/get-one-staff/:id_card`, 
                validateJWT, 
                idCardValidator(), 
                verifyError, 
